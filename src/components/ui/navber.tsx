  ...
  const categories = [
    { 
      ...
      subcategories: [
        ...
        { name: "Custom PC", href: "/category/custom-pc" },
        { name: "All-in-One PC", href: "/category/all-in-one-pc" },
        { name: "Portable Mini PC", href: "/category/mini-pc" },
      ]
    },
    { 
      name: "Laptop", 
      ...
      subcategories: [
        ...
        { name: "Ultrabook", href: "/category/ultrabook" },
        { name: "MacBook", href: "/category/macbook" },
        { name: "Traditional Laptop", href: "/category/traditional-laptop" },
      ]
    },
    { 
      name: "Component", 
      ...
      subcategories: [
        ...
        { name: "HDD", href: "/category/hdd" },
        { name: "Casing", href: "/category/casing" },
        { name: "Cooler", href: "/category/cooler" },
    ...
    { 
      ...
      subcategories: [
        ...
        { name: "Professional Monitor", href: "/category/professional-monitor" },
        { name: "Regular Monitor", href: "/category/regular-monitor" },
      ]
    },
    { 
      name: "UPS", 
    ...
    { 
      ...
      subcategories: [
        ...
        { name: "Attendance Machine", href: "/category/attendance-machine" },
    ...
    { 
      ...
      subcategories: [
        ...
        { name: "Speaker", href: "/category/speaker" },
        { name: "Webcam", href: "/category/webcam" },
        { name: "Microphone", href: "/category/microphone" },
        { name: "USB Hub", href: "/category/usb-hub" },
        { name: "Cable & Adapter", href: "/category/cable-adapter" },
      ]
    },
    { 
      name: "Gadget", 
      ...
      subcategories: [
        ...
        { name: "Trimmer", href: "/category/trimmer" },
        { name: "Drone", href: "/category/drone" },
